...
const generateRandomBlankState = () => ({
...
class App extends Component {
  constructor(props) {
    ...
    this.state = generateRandomBlankState();
  ...
  handleReset() {
    this.setState(generateRandomBlankState());
  }
  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        {submitted && <Indicator correctAnswer={calculateAnswer(percent, years, dollars)} yourAnswer={answerNumber} />}
      </div>
    );
  }
}
